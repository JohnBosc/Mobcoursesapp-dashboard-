            ...
            <div class="row">
                ...
                <div class="col-sm col-lg-6 col-md-6">
                    ...
                    <div class="panel-body form-add">
                        <c:url value="${contextRoot}/course/save" var="urlSave"/>
                        <f:form modelAttribute="course" action="${urlSave}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <f:select path="subject.subjectID" itemValue="subjectID" items="${subjects}"
                            ...
                            <div class="form-group">
                                <label for="file"><fmt:message
                                        key="common.course.photo.upload"/></label>
                                <f:input path="photo" type="file" id="file" class="form-control form-control-md"
                                         name="imageFile"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <f:select path="courseAuthor.courseAuthorID" items="${courseAuthors}" itemLabel="name"
                                          itemValue="courseAuthorID"
                                          class="form-control form-control-sm"/>
                            </div>
                            <div class="form-group">
                                <label><fmt:message key="common.course.description"/></label>
                                <f:textarea path="courseDescription" class="form-control" cssStyle="resize: none!important;"/>
                            </div>
                            <div class="form-group">
                                <label><fmt:message key="common.course.details"/></label>
                                <f:textarea path="otherDetails" class="form-control" cssStyle="resize: none!important;"/>
                            </div>
                            <div class="form-group">
                                <label><fmt:message key="common.course.requirements"/></label>
                                <f:textarea path="requirements" class="form-control" cssStyle="resize: none!important;"/>
                            </div>
