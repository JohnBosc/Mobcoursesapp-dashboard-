...
<head>
    ...
    <title><fmt:message key="common.course"/> </title>
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="index.html"><fmt:message key="common.dashboard"/> </a>
                </li>
                <li class="breadcrumb-item active"><fmt:message key="common.course"/> </li>
            </ol>
